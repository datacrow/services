...
import net.datacrow.onlinesearch.metacritic.task.MetacriticGameSearch;
import net.datacrow.onlinesearch.metacritic.task.MetacriticSearch;

public class MetacriticGameServer extends MetacriticServer {
    ...
    public SearchTask getSearchTask(IOnlineSearchClient listener,
        ...
        MetacriticSearch task = new MetacriticGameSearch(listener, this, mode, query);
