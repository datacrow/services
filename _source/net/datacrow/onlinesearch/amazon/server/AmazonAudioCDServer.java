...
public class AmazonAudioCDServer extends AmazonServer {

    private Collection<SearchMode> modes = new ArrayList<SearchMode>();
    
    public AmazonAudioCDServer() {
        super();

        modes.add(new KeywordSearchMode("Music", "Keyword", AudioCD._A_TITLE));
        modes.add(new ItemLookupSearchMode("Music", ItemLookupSearchMode.getDescription(ItemLookupSearchMode._EAN), ItemLookupSearchMode._EAN, AudioCD._N_EAN));
        modes.add(new ItemLookupSearchMode("Music", ItemLookupSearchMode.getDescription(ItemLookupSearchMode._UPC), ItemLookupSearchMode._UPC, AudioCD._N_EAN));
