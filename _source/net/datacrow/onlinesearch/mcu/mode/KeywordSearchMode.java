...
public class KeywordSearchMode extends SearchMode {
    ...
    public String getSearchCommand(String s) {
        return "/cgi-brs/BasesHTML/isbn/BRSCGI?CMD=VERLST&BASE=ISBN&DOCS=1-15&CONF=AEISPA.cnf&OPDEF=AND&SEPARADOR=&WDIS-C=DISPONIBLE&WGEN-C=&WISB-C=&WAUT-C=&WTIT-C=" + s;
    }
